    ...
    <div class="bg-backdrop container-sm">
      <div class="container bg-data">
        <div class="container input-place">
                  ...
                  <a class="btn btn-info" href="index2.php" style="margin-right: 10px;">
                    Lihat Kos Sebelah
                  </a>
                  ...
                  <a class="btn btn-secondary" style="color: white; margin-right:10px;" href="edit-aman.php">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="delete-case6.php" method="post">
                            <select class="form-select mb-3" aria-label="Pilih Penghuni" name="penghuni" id="penghuni" onclick="changePreview(this)">
                              ...
                              <?php
                                ...
                                $query = mysqli_query($conn,"SELECT * FROM finalproject");

                                if ( mysqli_num_rows($query) > 0 ) {

                                  foreach ($query as $penghuni) {
                                    echo "<option data-value='{\"id\":\"".$penghuni['id']."\",\"nama\":\"".$penghuni['nama']."\",\"asal\":\"".$penghuni['alamat']."\",\"kampus\":\"".$penghuni['kampus']."\",\"no_hp\":\"".$penghuni['no_hp']."\",\"kamar\":\"".$penghuni['kamar']."\"}'>".$penghuni['nama']." di kamar no ".$penghuni['kamar']."</option>";
                                  }
                  ...
                  <div class="modal fade" id="insertDataModal" tabindex="-1" aria-labelledby="insertDataModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="insert-case6.php" method="post">
                            <div class="mb-3">
                              <label for="name" class="form-label">Nama</label>
