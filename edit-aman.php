...
<head>
    ...
    <style>
        body {
            ...
            padding: 0 0 20px 0;
            background-image: url('kost-eksklusif-di-yogyakarta-1360x908.jpg');
            ...
            <div class="card-header pilih">
                ...
                <select name="penghuni" id="penghuni" onchange="changePreview(this);" style="margin-left: 10px;" class="form-select">
                    ...
                    <?php
                        ...
                        foreach ($penghuni as $individu) {
                            echo "
                            <option data-value='{\"id\":\"".$individu['id']."\",\"nama\":\"".$individu['nama']."\",\"asal\":\"".$individu['alamat']."\",\"kampus\":\"".$individu['kampus']."\",\"no_hp\":\"".$individu['no_hp']."\",\"kamar\":\"".$individu['kamar']."\"}'>".$individu['nama']." di Kamar = ".$individu['kamar']."</option>";
                        }
                    ?>
                </select>
            </div>
            <div class="card-body">
                <form action="modify-case6.php" method="post" id="formInput">
                    <div class="mb-3">
